# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-07-23 14:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', otree.db.models.StringField(max_length=10000, null=True)),
                ('institute', otree.db.models.StringField(max_length=10000, null=True)),
                ('state', otree.db.models.StringField(max_length=10000, null=True)),
                ('language', otree.db.models.StringField(max_length=10000, null=True)),
